...
const Contact = () => {
    ...
    return (
        <div className="py-16 px-4 lg:px-14  min-h-screen">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    {contactInfo.map((info, index) => (
                        <div 
                            key={index}
                            className=" border-2 border-gray-200 p-5 hover:border-primary hover:bg-gray-300 hover:text-black rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-center"
                        >
                            ...
                            {info.details.map((detail, idx) => (
                                <p key={idx} className="text-sm text-gray-600 font-semibold mb-1">
                                    {detail}
                                </p>
                            ))}
                        </div>
